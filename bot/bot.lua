...
chats = {}
plugins = {}
helper_username = 'Tghelper534bot'  -- Input Helper Username Here Without @
...
function tdcli_update_callback (data)
	...
	if (data.ID == "UpdateNewMessage") then
		...
		redis:incr(hash)
		if not redis:get("Open:Chats") then
      ...
      redis:setex("Open:Chats", 8, true)
    end
    if not redis:get("Is:Typing") then
      ...
      redis:setex("Is:Typing", 500, true)
    end
