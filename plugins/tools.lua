--Begin Tools.lua :)
local SUDO = ایدی عددی مدیر -- put Your ID here! <===
...
if ((matches[1] == 'poinshtan' and not Clang) or (matches[1] == "مهدی" and Clang)) then
...
_Sudoer And Admins poinshtan Bot Help :_
...
text = [[
_راهنمای ادمین و سودو های ربات poinshtan:_
